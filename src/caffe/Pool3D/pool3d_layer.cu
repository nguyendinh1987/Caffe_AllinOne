...
#include "caffe/Pool3D/pool3d_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
__global__ void MaxPool3DForward(const int nthreads, const Dtype* bottom_data,
...
template <typename Dtype>
__global__ void AvePool3DForward(const int nthreads, const Dtype* bottom_data,
    const int num, const int channels, const int length, const int height,
    const int width, const int pooled_length, const int pooled_height, const int pooled_width,
...
template <typename Dtype>
__global__ void MaxPool3DBackward(const int nthreads, const Dtype* bottom_data,
...
template <typename Dtype>
__global__ void AvePool3DBackward(const int nthreads, const Dtype* top_diff,
    const int num, const int channels, const int length, const int height,
    const int width, const int pooled_length, const int pooled_height, const int pooled_width,
